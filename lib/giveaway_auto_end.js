...
const { GiveawayDrawWinner } = require("./giveaway_draw_winner"); // używamy do losowania zwycięzców
      ...
      while (true) {
        ...
        try {
          ...
          if (endedGiveaways.length > 0) {
            ...
            // emitujemy asynchronicznie, by dać czas na podpięcie listenerów
        ...
        // Jeśli loopEvent === false i zakończyliśmy choć jedno giveaway,
        // to przerywamy dalsze sprawdzanie:
        if (!loopEvent && endedGiveaways.length > 0) {
          break;
        }

        // Czekaj loopTime sekund zanim wrócimy do początku pętli
